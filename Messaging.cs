...
public class Messaging
{
    ...
    public void SendMessage(User user, ServerChatMessageType msg_type, string message)
    {
        ...
        var nid = this._em.GetComponentData<NetworkId>(user.LocalCharacter._Entity);
    ...
    public void SendMessage(Entity userEntity, ServerChatMessageType msg_type, string message)
    {
        var entity = this._em.CreateEntity(
            ComponentType.ReadOnly<NetworkEventType>(),      //event type
            ComponentType.ReadOnly<SendEventToUser>(),       //send it to user
        ...
        var user = this._em.GetComponentData<User>(userEntity);
        var nid = this._em.GetComponentData<NetworkId>(userEntity);
